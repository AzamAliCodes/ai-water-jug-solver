...
public class AStarSolver {
    ...
    public AStarSolver(int capA, int capB, int target) {
        this.capA = capA;
        this.capB = capB;
        this.target = target;
    }
    ...
    private class Node implements Comparable<Node> {
        ...
        public int compareTo(Node other) {
             ...
             // Tie-breaking: favor lower heuristic (closer to target) if f is same
             return Integer.compare(this.f - this.g, other.f - other.g); 
        }
    }
